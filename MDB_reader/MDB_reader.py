...
def do_artic():
    ...
    path_mdb = '/mnt/c/data_luis/octac_work/arc_test/match-ups/MDB_OLCI_WFR_INSITU_2016_2019.nc'
    path_out = '/mnt/c/data_luis/octac_work/arc_test/match-ups/MDB_OLCI_WFR_INSITU_2016_2019_reflectance.csv'
